...
public class AuthenticationAuditServiceImpl implements IAuthenticationAuditService {
    ...
    private void record(Long userId, String username, String eventType, boolean successful,
