...
public class Email {
    ...
    private Email(String value) { this.value = normalize(value); }

    public static Email of(String value) { return value == null || value.isBlank() ? null : new Email(value); }
    ...
    @Override public boolean equals(Object other) { return other instanceof Email email && Objects.equals(value, email.value); }
