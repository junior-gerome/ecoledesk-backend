...
public class PhoneNumber {
    ...
    private PhoneNumber(String value) { this.value = normalize(value); }
    ...
    private static String normalize(String rawValue) {
        ...
        if (!FORMAT.matcher(normalized).matches()) throw new IllegalArgumentException("phone number must contain 8 to 15 digits");
        return normalized;
    }
    @Override public boolean equals(Object other) { return other instanceof PhoneNumber phoneNumber && Objects.equals(value, phoneNumber.value); }
