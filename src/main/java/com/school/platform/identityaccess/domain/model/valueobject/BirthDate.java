...
public class BirthDate {
    ...
    public int ageOn(LocalDate date) {
        return Period.between(value, Objects.requireNonNull(date, "date must not be null")).getYears();

         }

    @Override 
    public boolean equals(Object other) {
        return other instanceof BirthDate birthDate && Objects.equals(value, birthDate.value);
     }
